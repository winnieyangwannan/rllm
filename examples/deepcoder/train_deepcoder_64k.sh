...
# TODO: Update this path to your 32K checkpoint after stage 2 training
...
python3 -m examples.deepcoder.train_deepcoder \
    ...
    actor_rollout_ref.actor.ppo_max_token_len_per_gpu=128000 \
    ...
    trainer.experiment_name='deepcoder-14b-64k' \
