...
def process_nq_dataset(input_dir: str = None, output_dir: str = "processed_data", 
                      train_size: int = 10000, val_size: int = 1000):
...
def main():
    ...
    # Process the dataset
    train_file, val_file, combined_file = process_nq_dataset(
