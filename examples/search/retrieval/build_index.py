...
def build_dense_index(corpus: List[str], output_dir: str, model_name: str = 'intfloat/e5-base-v2'):
    ...
    try:
        ...
        try:
            ...
            if encoder is None:
                raise Exception("No sentence transformer model available. Please ensure internet connectivity or pre-download a model.")
...
def build_sparse_index(corpus: List[str], output_dir: str):
    ...
    sparse_data = {
        "tokenized_corpus": [' '.join(tokens) for tokens in tokenized_corpus],
...
def build_indices(corpus_file: str, output_dir: str, max_docs: int = None, 
    ...
    summary = {
        ...
        "dense_index": dense_index_file,
        "sparse_index": sparse_index_file,
        "corpus_saved": corpus_file_out,
