...
class TestDetectMimeType:
    def test_png(self):
        from rllm.experimental.agents.vlm_agent import _detect_mime_type
...
class TestImageToDataUri:
    def test_bytes_png(self):
        from rllm.experimental.agents.vlm_agent import _image_to_data_uri
...
class TestBuildVLMContentBytes:
