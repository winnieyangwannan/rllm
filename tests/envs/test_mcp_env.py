...
from rllm.environments.tools.mcp_env import MCPEnvironment, MCPConnectionManager
...
class TestMCPEnvironment:
    ...
    def test_step_with_finish_tool_call_with_arguments(self, mock_init, mock_start):
        ...
        action = [{
            ...
            "function": {
                "name": "finish",
                "arguments": {"response": "The correct final answer"}
            }
        }]
    ...
    def test_connection_manager_singleton_behavior(self, mock_start, mock_init):
        ...
        env1 = MCPEnvironment(mcp_server_command="test_command")
        env2 = MCPEnvironment(mcp_server_command="test_command")
