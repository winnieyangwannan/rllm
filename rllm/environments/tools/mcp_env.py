...
class MCPConnectionManager:
    ...
    def __init__(self, mcp_server_command: str, mcp_server_args: List[str] = None, 
...
class MCPEnvironment(BaseEnv):
    ...
    def __init__(self, task: Optional[Dict] = None, mcp_server_command: str = None, 
                 mcp_server_args: List[str] = None, mcp_server_env: Dict[str, str] = None,
                 reward_fn: Optional[RewardFunction] = None, max_steps=10):
        """
        ...
        with MCPEnvironment._manager_lock:
            if MCPEnvironment._connection_manager is None:
                MCPEnvironment._connection_manager = MCPConnectionManager(
