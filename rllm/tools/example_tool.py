...
class SleepTool(Tool):
    ...
    def json(self) -> dict[str, Any]:
        ...
        """
        return {"type": "function", "function": {"name": self.name, "description": self.description, "parameters": {"type": "object", "properties": {"seconds": {"type": "number", "description": "Number of seconds to sleep"}}, "required": ["seconds"]}}}
...
async def main() -> None:
    ...
    tasks = [tool(1, use_async=True), tool(2, use_async=True)]
