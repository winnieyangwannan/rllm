...
class AskQuestionAboutVideoCamel(CamelTool):
    def __init__(self):
        super().__init__(function_tool=FunctionTool(VideoAnalysisToolkit().ask_question_about_video))
...
if __name__ == "__main__":
    ...
    try:
        result = AskQuestionAboutVideoCamel()(**{"video_path": video_file, "question": question})
