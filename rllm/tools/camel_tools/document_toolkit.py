...
class DocumentProcessingToolkit(BaseToolkit):
    ...
    def extract_document_content(self, document_path: str) -> tuple[bool, str]:
        ...
        Args:
            document_path (str): The path of the document to be processed, either a local path or a URL. It can process webpages, pdf files, docx files, json files, python files, xml files, zip files.
        ...
        if self._is_webpage(document_path):
            ...
            if document_path.endswith(".pdf"):
                ...
                logger.error(f"Could not process file {document_path}")
                return False, f"Could not process file {document_path}"
...
if __name__ == "__main__":
    ...
    print("DocumentProcessingCamel result:", result)
