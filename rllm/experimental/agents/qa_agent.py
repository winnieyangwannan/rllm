...
QA_SYSTEM_PROMPT = """\
You are a question answering assistant. Answer the question concisely and accurately.
Provide your final answer clearly. If you know the answer, state it directly."""


class QAAgentFlow:
    """Question answering agent flow."""
