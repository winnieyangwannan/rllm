...
def parse_args():
    ...
    parser.add_argument(
        "--num-devices", "-nd", type=int, default=8, help="Number of devices to use."
    )
    parser.add_argument(
        "--grad_accum", type=int, default=1, help="Gradient accumulation steps."
    )
    parser.add_argument("--train_path", type=str, default="./data/train.jsonl", help="Path to training jsonl file")

    parser.add_argument("--test_path", type=str, default="./data/test.jsonl", help="Path to testing jsonl file")

    parser.add_argument(
        "--special_token_path", type=str, default="./data/tokens.json", help="Path to token json file"
    )
    parser.add_argument(
        "--no-grad-ckpt",
        action="store_true",
    ...
    parser.add_argument(
        "--model_name", default="deepseek-ai/DeepSeek-R1-Distill-Qwen-32B", type=str
    )
    parser.add_argument(
